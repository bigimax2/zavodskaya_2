...
class Jobs(models.Model):
    ...
    jobs_comments = models.CharField(max_length=255, null=True, blank=True, verbose_name='Уточнения по заказу:')
...
class Consumers(models.Model):
    ...
    job = models.ForeignKey(Jobs, blank=True, null=True, on_delete=models.CASCADE, verbose_name='выбрать вид работ')
